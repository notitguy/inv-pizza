  ...
  <main>
    ...
    <section class="gallery grid parallax main-wrapper">
      ...
      <div class="gallery__header">
        ...
        <p>Nezapomeňte nás sledovat na <a href="https://www.instagram.com/invitaly_piazzetta/" target="_blank" class="bottomline" data-event="instagramClick">Instagramu</a>  pro více novinek.</p>
      </div>
    ...
    <h2 class="is--centered">Chcete ochutnat?</h2>
      <div class="two-blocks__card">
        ...
        <a href="https://www.invitaly.cz/files/menu_vladislavova.pdf" target="_blank" class="primary" data-event="menuDownload">Otěvřít menu <img src="assets/img/icons/pdf.svg" width="25px" style="margin: -0.4rem 0 0 1rem;" alt="Menu Invitaly"></a>
      </div>
      <div class="two-blocks__card">
        ...
        <a href="https://invitaly.choiceqr.com/delivery/online-menu" target="_blank" class="primary" data-event="orderClickSection" rel="nofollow">Objednat teď <img src="assets/img/icons/delivery.svg" width="32px" height="32px" style="margin: -0.4rem 0 0 1rem;" alt="Order Invitaly"></a>
      </div>
    </section>
  </main>
