...
<body class="body--dark is--home" id="top">
  ...
  <?php include '../blocks/header__en.php'; ?>
  ...
  <main>
              ...
              <div class="plate-slider__content-block is--plate-slider">
                ...
                <div class="two-buttons text--mask">
                  ...
                  <a href="#lunch" class="plate-slider__btn-block" style="background-color: rgb(0 0 0 / 50%);">
                    <span class="plate-slider__btn">Lunch menu</span>
                    <img src="/assets/img/icons/arrow--white.svg" alt="icon" class="plate-slider__btn-icon" width="34" height="24" />
                  </a>
                </div>
              </div>
    ...
    <section class="gallery grid parallax main-wrapper">
      ...
      <div class="gallery__header">
        ...
        <p>Make sure to follow us on <a href="https://www.instagram.com/invitaly_pizza/" target="_blank" class="bottomline" data-event="instagramClick">Instagram</a> for more.</p>
      </div>
    ...
    <section class="reviews grid main-wrapper">
        ...
        <div class="reviews__header">
          ...
          <p>Thank you!</p>
          <a href="https://g.page/r/CWQq2MAFawinEB0/review" target="_blank" class="bottomline" data-event="reviewClick">Leave your review</a>
        </div>
    ...
    <h2 class="is--centered">Ready to try?</h2>
      <div class="two-blocks__card">
        ...
        <a href="https://www.invitaly.cz/files/menu_vladislavova.pdf" target="_blank" class="primary" data-event="menuDownload">See menu <img src="/assets/img/icons/pdf.svg" width="25px" style="margin: -0.4rem 0 0 1rem;" alt="Menu Invitaly"></a>
      </div>
      <div class="two-blocks__card">
        ...
        <a href="https://invitaly.choiceqr.com/delivery/online-menu" target="_blank" class="primary" data-event="orderClickSection" rel="nofollow">Order now <img src="/assets/img/icons/delivery.svg" width="32px" height="32px" style="margin: -0.4rem 0 0 1rem;" alt="Order Invitaly"></a>
      </div>
    </section>
  </main>
