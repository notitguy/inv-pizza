...
<nav class="mobile-menu">
  ...
  <ul class="mobile-menu_list">
    <li><a href="#top">Úvod</a></li>
    <li><a href="#lunch">Denní Menu</a></li>
    <li><a href="#menu">Menu</a></li>
    <li><a href="#about">O nás</a></li>
    <li><a href="#contact">Kontakty</a></li>
  </ul>
  <a href="https://wolt.com/cs/cze/prague/restaurant/invitaly" target="_blank" rel="nofollow" class="primary" data-event="orderClickTop">Objednat <img src="/assets/img/icons/wolt.png" width="55px" height="20px" style="margin: -0.4rem 0 0 1rem;" alt="Order Invitaly"></a>
