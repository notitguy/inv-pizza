          ...
          <div class="col-md-6">
            <h3 style="color: var(--accent-color);">Rezervace:</h3>
              <ul class="m-b" style="--mb: 3.4rem">
                ...
                <li>
                  Objednat online: <a href="https://invitaly.choiceqr.com/delivery/online-menu" target="_blank" rel="nofollow" data-event="orderClickFooter"><img src="/assets/img/icons/wolt.png" width="55px" height="20px" style="margin: -0.4rem 0 0 1rem;" alt="Order Invitaly"></a>
                </li>
              </ul>
